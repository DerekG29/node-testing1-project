...
function findLargestInteger(integers) {
  ...
  for (let obj of integers) {
    if (obj.integer > largestInteger) largestInteger = obj.integer;
  }
...
class Car {
  ...
  drive(distance) {
    ...
    this.tank -= Math.floor(distance / this.mpg);
  ...
  refuel(gallons) {
    this.tank += gallons;
    if (this.tank > this.tankSize) this.tank = this.tankSize;
  }
}
